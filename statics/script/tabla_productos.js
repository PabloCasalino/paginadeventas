const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://paginadeventas.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://paginadeventas.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
